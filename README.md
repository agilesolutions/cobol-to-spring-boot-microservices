...
3. Use Spring Cloud's support for resiliency patterns such as Circuit Breaker, Retry, and Bulkhead to improve the resilience of the new microservices when calling external services, such as the legacy system or other microservices.
